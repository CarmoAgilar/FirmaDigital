...
public class Comprobar extends JFrame implements ActionListener {
    ...
    public Comprobar(Main inicio) {
        ...
        butComprobar.setBounds(10, 220, 190, 23);
        contentPane.add(butComprobar);

        JButton butMenuPrincipal = new JButton("Volver");
        ...
        if (rutaArchivo.equals("") || rutaFirma.equals("") || rutaClavePublica.equals("")) {
            ...
            try {
                ...
                if (respuesta) {
                    ...
                    JOptionPane.showMessageDialog(this, "Autenticidad no confirmada.", "Resultado", JOptionPane.WARNING_MESSAGE);
                }
            } catch (Exception e) {
