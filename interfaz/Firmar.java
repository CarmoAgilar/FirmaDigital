...
public class Firmar extends JFrame implements ActionListener {
    ...
    public Firmar(Main inicio) {
        ...
        JButton butSubirDocumento = new JButton("Explorar archivos");
    ...
    public void firmarArchivo() {
        ...
        if (rutaArchivo.equals("") || password.equals("")) {
            ...
            JOptionPane.showMessageDialog(this, "Elija la ubicación.");
            JFileChooser fc = new JFileChooser();
