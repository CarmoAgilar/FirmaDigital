...
public class Generar extends JFrame implements ActionListener {
    ...
    public Generar(Main inicio) {
        this.inicio = inicio;
        setTitle("Generar archivo de contraseña");
        ...
        JLabel labConfirmarContrasena = new JLabel("Confirmar la contraseña:");
        labConfirmarContrasena.setBounds(30, 113, 261, 20);
        contentPane.add(labConfirmarContrasena);
        JButton butGenerarClaves = new JButton("Confirmar contraseña");
        butGenerarClaves.setBounds(30, 161, 180, 20);
        ...
        JButton butIrAFirma = new JButton("Volver");
    ...
    public void exportarClavePublica() {
        ...
        if (option == 0) {
            ...
            JOptionPane.showMessageDialog(this, "Elija la ubicación del archivo.");
            ...
            if (seleccion == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(this, e.getMessage(), "Error. Vuelva a intentarlo.", JOptionPane.ERROR_MESSAGE);
                }
